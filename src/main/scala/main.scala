					...
					complete {
						val fileName = UUID.randomUUID().toString
	              		val temp = System.getProperty("java.io.tmpdir")
	               		val filePath = "/home/aps/uploadedFiles/temp/" + fileName
                          ...
                          if(check1 == true) {
                            ...
                            val newPath = "/home/aps/uploadedFiles/MainFiles/"
                            ...
                            HttpResponse(StatusCodes.OK, entity = s"File successfully uploaded. File size is $fileSize. Path is $finalPath")
